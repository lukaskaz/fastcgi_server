...
#define FCGI_POLLFDS_SIZE           (FCGI_MAX_CONNS + 1)
#define FCGI_CONNS_SIZE             FCGI_MAX_CONNS
#define FCGI_SOCKFD_POS             FCGI_MAX_CONNS
#define FCGI_MAX_CONNS_QUEUE_SIZE   (2 * FCGI_MAX_CONNS)

#define FCGI_POLL_WAIT_INFINITE     (-1)
